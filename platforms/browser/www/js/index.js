...
/******/ 	__webpack_require__.p = "/mnt/d/Sites/Gains/www/js";
/******/
/******/
...
var _modal = __webpack_require__(/*! bootstrap/js/src/modal */ "./node_modules/bootstrap/js/src/modal.js");
...
document.addEventListener('deviceready', function (e) {
    ...
    // );
    $('.js-nav').on('click touch', function (e) {
        $('#settings').toggleClass('exposed');
    });

    $(document.body).on('click touch', '.js-menu', function (e) {
        $('#' + e.target.getAttribute('aria-controls')).parent().toggleClass('menu-open');
    });

    $(document.body).on('click touch', '.close', function (e) {
